...
from emotion_model.emotion_pipeline import emotion_pipe, emotion_clf
from emotion_model import __version__ as _version
from emotion_model.processing.data_manager import load_dataset, save_pipeline, save_model
